...
private Fragment fragment;
    ...
    private void carregaFragment(Bundle bundle) {
        ...
        if (tipoAtleta.equals("comum")){
            fragment = new CadastroAtletaComum();
        }
        if (tipoAtleta.equals("juvenil")){
            fragment = new CadastroAtletaJuvenil();
        }else {
            fragment = new CadastroAtletaSenior();
        }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.menuCadastroJuvenil ){
            bundle.putString("tipoAtleta","juvenil");
            intent.putExtras(bundle);
            this.startActivity(intent);
            this.finish();
            return true;
        }if (id == R.id.menuCadastroSenior ){
